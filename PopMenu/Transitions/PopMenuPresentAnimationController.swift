...
final public class PopMenuPresentAnimationController: NSObject, UIViewControllerAnimatedTransitioning {
    ...
    public func animateTransition(using transitionContext: UIViewControllerContextTransitioning) {
        ...
        UIView.animate(withDuration: animationDuration, delay: 0.0, usingSpringWithDamping: 2.0, initialSpringVelocity: 7.0, options: [.beginFromCurrentState, .curveEaseInOut], animations: animations) { _ in
